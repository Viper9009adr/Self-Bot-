...
describe('media capability unavailable contract helpers', () => {
  it('exposes stable unavailable error code and messages', () => {
    ...
    expect(imageErr.message).toBe('Image capability not configured. Set LOCAL_COMFYUI_URL, NVIDIA_NIM_API_KEY, GOOGLE_API_KEY, LOCAL_IMAGE_URL, or OPENAI_API_KEY.');
